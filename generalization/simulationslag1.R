...
expar1b1 <- gc.test(niters, numcores, 256, block.sizes[1], 
...
expar1b2 <- gc.test(niters, numcores, 256, block.sizes[2], 
                    function(n) simulate.far(n, 2, 0, 1, 1, list(expar1)), P = 1000)
saveRDS(expar1b2, paste0("../results/basecasegen/expar1_", block.sizes[2], ".Rds"))

expar1b3 <- gc.test(niters, numcores, 256, block.sizes[3], 
                    function(n) simulate.far(n, 2, 0, 1, 1, list(expar1)), P = 1000)
...
expar2b1 <- gc.test(niters, numcores, 256, block.sizes[1], 
...
expar2b2 <- gc.test(niters, numcores, 256, block.sizes[2], 
                    function(n) simulate.far(n, 2, 0, 1, 1, list(expar2)), P = 1000)
saveRDS(expar2b2, paste0("../results/basecasegen/expar2_", block.sizes[2], ".Rds"))

expar2b3 <- gc.test(niters, numcores, 256, block.sizes[3], 
                    function(n) simulate.far(n, 2, 0, 1, 1, list(expar2)), P = 1000)
...
expar3b1 <- gc.test(niters, numcores, 256, block.sizes[1], 
...
expar3b2 <- gc.test(niters, numcores, 256, block.sizes[2], 
                    function(n) simulate.far(n, 2, 0, 1, 1, list(expar3)), P = 1000)
saveRDS(expar3b2, paste0("../results/basecasegen/expar3_", block.sizes[2], ".Rds"))

expar3b3 <- gc.test(niters, numcores, 256, block.sizes[3], 
                    function(n) simulate.far(n, 2, 0, 1, 1, list(expar3)), P = 1000)
...
logis1b1 <- gc.test(niters, numcores, 256, block.sizes[1], 
...
logis1b2 <- gc.test(niters, numcores, 256, block.sizes[2], 
                    function(n) simulate.far(n, 2, 0, 1, 1, list(logis1)), P = 1000)
saveRDS(logis1b2, paste0("../results/basecasegen/logis1_", block.sizes[2], ".Rds"))

logis1b3 <- gc.test(niters, numcores, 256, block.sizes[3], 
                    function(n) simulate.far(n, 2, 0, 1, 1, list(logis1)), P = 1000)
...
#simulation of the second scenario
logis2b1 <- gc.test(niters, numcores, 256, block.sizes[1], 
...
logis2b2 <- gc.test(niters, numcores, 256, block.sizes[2], 
                    function(n) simulate.far(n, 2, 0, 1, 1, list(logis2)), P = 1000)
saveRDS(logis2b2, paste0("../results/basecasegen/logis2_", block.sizes[2], ".Rds"))

logis2b3 <- gc.test(niters, numcores, 256, block.sizes[3], 
                    function(n) simulate.far(n, 2, 0, 1, 1, list(logis2)), P = 1000)
...
#simulation of the third scenario
logis3b1 <- gc.test(niters, numcores, 256, block.sizes[1], 
...
logis3b2 <- gc.test(niters, numcores, 256, block.sizes[2], 
                    function(n) simulate.far(n, 2, 0, 1, 1, list(logis3)), P = 1000)
saveRDS(logis3b2, paste0("../results/basecasegen/logis3_", block.sizes[2], ".Rds"))

logis3b3 <- gc.test(niters, numcores, 256, block.sizes[3], 
                    function(n) simulate.far(n, 2, 0, 1, 1, list(logis3)), P = 1000)
